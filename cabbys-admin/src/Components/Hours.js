...
import { Layout, Divider, Col, Row, TimePicker, Button } from 'antd'
...
export default class Hours extends Component {
  ...
  render() {
    ...
    return (
      <Layout style={{ backgroundColor: '#fff', display: 'flex', justifyContent: 'space-evenly' }}>
        ...
        <Row style={{ display: 'flex', justifyContent: 'space-around' }}>
          {Object.keys(hours).map((hour) => {
            if (hours[hour] === 'Closed') {
              return (
                <Col span="3" style={{ margin: 'auto 0', textAlign: 'center' }}>
                  <Button
                    onClick={this.open.bind(this, hour)}>Closed</Button>
                </Col>
              )
            }
            ...
            console.log(start)
            return (
              <Col span="3" style={{ textAlign: 'center', margin: 'auto 0' }}>
                <Row>
                  <h3>{hour}</h3>
                </Row>
                <Divider />
